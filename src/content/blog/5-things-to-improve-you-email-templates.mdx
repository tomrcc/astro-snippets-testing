...
<CTA background_color="#f1f1f1" text_color="#000000" text="Does this work better in the content editor" />
<Alert background_color="#ff0000" text_color="#ffffff">This text should be black on a red bg</Alert>
